...
\label{bab:1}
%----------------------------------------------------------------------------- %%
This chapter introduces the resource-fragmentation and network-locality problems addressed by this thesis. It defines the research questions, scope, objectives, contributions, research position, and research steps.
...
\begin{itemize}
    ...
    \item How can predicted scheduler targets and a single target-bin-score criterion select effective and safe eviction victims?
...
\begin{itemize}
    ...
    \item Predict feasible landing Nodes before eviction and select victims using projected target balance.
...
\begin{itemize}
    ...
    \item \textbf{A predicted-target victim selector:} Candidate Pods are compared using the projected bin score of their predicted landing Nodes.
...
\begin{enumerate}
    ...
    \item Define Node-state metrics, drain-candidate rules, target prediction, victim selection, and safety constraints.
