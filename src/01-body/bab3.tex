...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        x=1cm,y=1cm,>=stealth,
        box/.style={draw, line width=0.5pt, fill=white, align=center, text width=1.85cm, minimum height=0.72cm, inner sep=3pt},
        observebox/.style={draw, line width=0.5pt, fill=white, align=center, text width=1.6cm, minimum height=0.72cm, inner sep=3pt},
        line/.style={draw, line width=0.5pt, -stealth},
        plain/.style={draw, line width=0.5pt},
        body/.style={font=\sffamily\scriptsize}
    ]
        \node[box] (state) at (0.0,4.1) {\textbf{\sffamily State}\\[-1pt]{\sffamily\scriptsize Pods and Nodes}};
        \node[box] (input) at (3.0,4.1) {\textbf{\sffamily Input}\\[-1pt]{\sffamily\scriptsize requests or usage}};
        \node[box] (rii) at (6.0,4.1) {\textbf{\sffamily RII}\\[-1pt]{\sffamily\scriptsize CPU-memory gap}};
        \node[box] (topsis) at (9.0,4.1) {\textbf{\sffamily TOPSIS}\\[-1pt]{\sffamily\scriptsize rank candidates}};

        \node[observebox] (observe) at (0.0,1.3) {\textbf{\sffamily Observe}\\[-1pt]{\sffamily\scriptsize outcome}};
        \node[box] (sched) at (3.0,1.3) {\textbf{\sffamily Scheduler}\\[-1pt]{\sffamily\scriptsize default place}};
        \node[box] (evict) at (6.0,1.3) {\textbf{\sffamily Evict}\\[-1pt]{\sffamily\scriptsize best safe Pod}};
        \node[box] (guard) at (9.0,1.3) {\textbf{\sffamily Guard}\\[-1pt]{\sffamily\scriptsize non-origin fit}};
        ...
        \draw[line] (observe.west) -- ++(-1.0,0) |- (state.west);
    \end{tikzpicture}%
    }
