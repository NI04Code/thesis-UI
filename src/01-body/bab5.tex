...
\begin{enumerate}
	...
	\begin{itemize}
		\item Pelajari cara sitasi dan \f{cross-reference} yang konsisten karena kedua fitur tersebut sangat penting dalam penulisan skripsi menggunakan \gls{latex}.
		\item Jika fakultas Anda memerlukan format sitasi selain APA (yang menjadi \f{default} di tingkat universitas), sesuaikan konfigurasi sitasi pada template.
		\item Jika Anda membutuhkan dukungan untuk bahasa lain, notasi matematis, atau penulisan kode program, sesuaikan paket dan konfigurasi template yang relevan.
	\end{itemize}
