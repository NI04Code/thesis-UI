...
%-----------------------------------------------------------------------------%
% \f{landscape} beserta tutorialnya.
...
% 			\item Dukungan untuk format laporan Ka\todo{Silakan hapus lampiran ini ketika Anda mulai menggunakan \f{template}.}
...
% 		\begin{itemize}
% 			\item Menambahkan kemampuan orientasi mpus Merdeka Mandiri di Fasilkom UI.
