...
This section presents the design and implementation of the Descheduler components developed in this research: the defragmentation-focused \textit{ResourceDefragmentation} policy, the Actual Usage Evictor runtime pre-eviction filter, and the Network-Aware Evictor with topology-based and latency-based cost models.
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\linewidth]{assets/pics/kube-descheduler-extension-position.png}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\linewidth]{assets/pics/defrag/highlevel_defrag.png}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\linewidth]{assets/pics/actual-usage/sysoverview-diagram.png}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=1.0\linewidth]{assets/pics/network-aware/sysoverview-diagram.png}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=1.0\linewidth]{assets/pics/network-aware/sysarc-diagram.png}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=1.0\linewidth]{assets/pics/network-aware/prometheus-scrape.png}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=0.3\linewidth]{assets/pics/network-aware/preevict-chaining.png}
...
Let \(K\) denote the number of candidate Nodes whose communication cost is no worse than the current placement, \(M\) the number of total candidates, and \(\rho_{\min}\) the configured \textit{MinBetterCandidatesPercent}. The eviction decision is determined using the threshold condition defined in the equation below:
