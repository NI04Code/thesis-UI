...
\begin{figure*}[tbp]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/pics/kube-descheduler-extension-position.png}
...
\begin{figure*}[tbp]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/pics/actual-usage/sysoverview-diagram.png}
...
\begin{figure*}[tbp]
	\centering
	\includegraphics[width=0.95\textwidth]{assets/pics/network-aware/sysoverview-diagram.png}
...
\begin{figure*}[tbp]
	\centering
	\includegraphics[width=0.95\textwidth]{assets/pics/network-aware/prometheus-scrape.png}
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.88\columnwidth]{assets/pics/network-aware/preevict-chaining-hires.png}
