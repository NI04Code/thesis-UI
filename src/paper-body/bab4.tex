...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{assets/pics/actual-usage/failure_rate_bar.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{assets/pics/actual-usage/disruption_duration_bar.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{l c c l l}
        ...
        workload-chatty & $50\,m$ & $240\,Mi$ & Idle & $network\mbox{-}group=checkout$ \\
        workload-cache & $50\,m$ & $40\,Mi$ & Idle & $network\mbox{-}group=checkout$ \\
...
\begin{enumerate}
    ...
    \item \textbf{ActualUsageEvictor protects workload-api.}
