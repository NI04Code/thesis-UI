...
\begin{figure*}[tbp]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/pics/actual-usage/failure_timeline_heatmap.png}
...
\begin{figure*}[tbp]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/pics/actual-usage/failure_rate_bar.png}
...
\begin{figure*}[tbp]
    \centering
    \includegraphics[width=0.95\textwidth]{assets/pics/actual-usage/disruption_duration_bar.png}
