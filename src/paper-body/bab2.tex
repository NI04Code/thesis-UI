...
This section reviews the theoretical concepts and prior work that form the foundation of this study, including Kubernetes resource management, resource fragmentation, Descheduler mechanisms, predicted-target eviction selection, runtime load-aware eviction guarding, and communication-aware placement.
