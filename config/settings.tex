...
\Var{\babTiga}{Policies Design and Architecture}
\Var{\babEmpat}{Policies Implementation}
\Var{\babLima}{Experiment and Evaluation}
\Var{\kesimpulan}{Conclusion and Future Work}
