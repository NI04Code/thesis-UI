...
%
% Judul laporan.
\def\judul{A Multi-Level Descheduler Policy for Cloud Resource Optimization: Combining Imbalance Indexing with Network Costs Evictor}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{A Multi-Level Descheduler Policy for Cloud Resource Optimization: Combining Imbalance Indexing with Network Costs Evictor}
