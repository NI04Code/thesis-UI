...
\strcompare{Kampus Merdeka}{\type}{} {
	\addtocontents{toc}{\protect\addvspace{-1em}}
    \addChapter{Declaration of Originality}
...
\strcompare{Laporan Kerja Praktik}{\type}
{
	...
	\addChapter{Internship Advisor Approval Page}
...
}
{
	...
	\putpdf{assets/pdfs/pengesahanSidang}
	\ifodd\thechapterpagecount\forceclearchapter\thispagestyle{onlypage}\fi
}}

{
	...
	%
	\addChapter{Artificial Intelligence Usage Statement}
	\include{src/00-frontMatter/pernyataanPenggunaanAI}
	\ifodd\thechapterpagecount\forceclearchapter\thispagestyle{onlypage}\fi
}
...
\strcompare{Kampus Merdeka}{\type}{} {
	...
	% Surat Pernyataan
	%
	\addChapter{Statement Letter}
	\include{src/00-frontMatter/suratPernyataan}
	\ifodd\thechapterpagecount\forceclearchapter\thispagestyle{onlypage}\fi
	...
	%
	\addChapter{Publication Approval Page}
